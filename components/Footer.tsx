      ...
      <div className="max-w-4xl mx-auto px-5 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-white font-semibold text-lg">Hrithik Jain</h3>
            <p className="text-neutral-400 text-sm mt-1">Product Manager</p>
            <p className="text-neutral-500 text-sm mt-4 leading-relaxed">
              Building high-impact growth, retention, and customer experience products across B2B and B2C.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-neutral-500 text-sm">
            © {currentYear} Hrithik Jain. All rights reserved.
          </p>
          <p className="text-neutral-500 text-sm">
